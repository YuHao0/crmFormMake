  ...
  <div class="forms">
    <el-form ref="form" v-show="them.showConfigurationProperties === 'forms'">
      <el-form-item label="字段名称">
        <el-input
          :disabled="true"
          v-model="them.conProPertiesForm.id"
        ></el-input>
      </el-form-item>
      <el-form-item label="标签名称">
        <el-input v-model="them.conProPertiesForm.label"></el-input>
      </el-form-item>
      <el-form-item label="ui类型">
        <!-- <el-input v-model="them.conProPertiesForm.uitype"></el-input> -->
        <!-- {{ getUiType }} -->
        <el-select
          v-model="them.conProPertiesForm.uitype"
          placeholder="请选择ui类型"
        >
          <el-option
            v-for="item in getUiType"
            :label="item.label"
            :value="item.value"
            :key="item.value"
          >
      ...
      <el-form-item label="是否更新">
        <el-select
          v-model="them.conProPertiesForm.updatable"
          placeholder="请选择（默认更新）"
        >
      ...
      <el-form-item
        v-show="showModule('placeholder', them.conProPertiesForm.uitype)"
        label="提示输入内容"
      >
        <el-input v-model="them.conProPertiesForm.placeholder"></el-input>
      </el-form-item>
      <el-form-item
        label="是否可编辑
             (可写表达式)(0可编辑 1不可编辑)"
      >
        <el-input
          v-model="them.conProPertiesForm.disable"
          placeholder="0可编辑 1不可编辑"
        ></el-input>
      </el-form-item>
      <el-form-item
        label="是否可见
      ...
      >
        <el-input
          v-model="them.conProPertiesForm.visible"
          placeholder="0不显示 1显示"
        ></el-input>
      </el-form-item>
      <el-form-item label="校验输入内容(正则)">
        <el-input v-model="them.conProPertiesForm.regex"></el-input>
      </el-form-item>
      <el-form-item
        v-show="showModule('lookup', them.conProPertiesForm.uitype)"
        label="URI链接"
      >
      ...
      <el-form-item label="选项">
        <el-input
          v-model="them.conProPertiesForm.options"
          placeholder="给label/value list值"
        ></el-input>
      </el-form-item>
      <el-form-item label="初始传参">
        <el-input v-model="them.conProPertiesForm.startwith"></el-input>
      </el-form-item>
      <el-form-item
        v-show="showModule('limit', them.conProPertiesForm.uitype)"
        label="限制行数"
      >
        <el-input v-model="them.conProPertiesForm.limit"></el-input>
      </el-form-item>
      <el-form-item label="是否必填(可写表达式)(0不限制 1限制)">
        <el-input
          v-model="them.conProPertiesForm.required"
          placeholder="0不限制 1限制"
        ></el-input>
      </el-form-item>
      <el-form-item label="尺寸">
        <el-select
          v-model="them.conProPertiesForm.size"
          placeholder="请选择(默认small)"
        >
      ...
      <el-form-item label="行">
        <el-input
          v-model="them.conProPertiesForm.rows"
          placeholder="用于定义高度"
        ></el-input>
      </el-form-item>
      <el-form-item label="字数限制">
        <el-input v-model="them.conProPertiesForm.maxlength"></el-input>
      </el-form-item>
      <el-form-item
        v-show="showModule('separater', them.conProPertiesForm.uitype)"
        label="显示间隔标识符"
      >
        <el-input
          v-model="them.conProPertiesForm.separater"
          placeholder="默认逗号,"
        ></el-input>
      </el-form-item>
      <el-form-item
        v-show="showModule('cascaderLength', them.conProPertiesForm.uitype)"
        label="层数"
      >
      ...
      <el-form-item label="显示格式">
        <el-input
          v-model="them.conProPertiesForm.format"
          placeholder="例如时间 YYYY-mm-dd"
        ></el-input>
      </el-form-item>
      <el-form-item label="默认值">
        <el-input v-model="them.conProPertiesForm.default"></el-input>
      </el-form-item>
      <el-form-item label="强制默认值">
        <el-input v-model="them.conProPertiesForm.detailDefault"></el-input>
      </el-form-item>
      <el-form-item label="自动计算">
        <el-input
          v-model="them.conProPertiesForm.compute"
          placeholder="设置jsonpath表达式"
        ></el-input>
      </el-form-item>
      <el-form-item label="查找带回窗口">
        <el-input
          v-model="them.conProPertiesForm.lookupwindow"
          placeholder="窗口ID"
        ></el-input>
      </el-form-item>
      <el-form-item
        v-show="showModule('param', them.conProPertiesForm.uitype)"
        label="查找窗口带参传递"
      >
        <el-input
          v-model="them.conProPertiesForm.param"
          placeholder="参数"
        ></el-input>
      </el-form-item>
      <el-form-item
        v-show="showModule('lookupcolumn', them.conProPertiesForm.uitype)"
        label="找带回数据源列"
      >
        <el-input
      ...
      <el-form-item
        v-show="showModule('returnback', them.conProPertiesForm.uitype)"
        label="查找带回目标列"
      >
        <el-input
      ...
      <el-form-item
        v-show="showModule('writeback', them.conProPertiesForm.uitype)"
        label="写入返回(writeback)"
      >
        <el-input
      ...
      <el-form-item label="是否折叠">
        <el-select
          v-model="them.conProPertiesForm.foldFlag"
          placeholder="请选择)"
        >
      ...
      <el-form-item label="数字加减专用">
        <el-select
          v-model="them.conProPertiesForm.editable"
          placeholder="请选择"
        >
      ...
      <el-form-item
        v-show="showModule('step', them.conProPertiesForm.uitype)"
        label="numberpicker步长"
      >
        <el-input
          v-model="them.conProPertiesForm.step"
          placeholder="专用于配合editable属性"
        ></el-input>
      </el-form-item>
      <el-form-item label="是否只读(可写表达式)(0只读 1不限制)">
        <el-input
          v-model="them.conProPertiesForm.readonly"
          placeholder="0只读 1不限制"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item
        v-show="showModule('uicontent', them.conProPertiesForm.uitype)"
        label="嵌入子ui内容"
      >
        <el-input
          type="textarea"
          v-model="them.uicontent"
          placeholder="用于inner_table"
        ></el-input>
      </el-form-item>
      <el-form-item label="下拉文本内容赋值">
        <el-input
          v-model="them.chineseid"
          placeholder="用于inner_table转为string"
        ></el-input>
      </el-form-item>
      <el-form-item
        v-show="showModule('label2value', them.conProPertiesForm.uitype)"
        label="前后端交互用label"
      >
        <el-input
          v-model="them.label2value"
          placeholder="决定数据库存value或label"
        ></el-input>
      </el-form-item>
    </el-form>
    <el-form ref="tabs" v-show="them.showConfigurationProperties === 'tabs'">
      <el-form-item label="对象类型/表名">
        <el-input
          v-model="them.conProPertiesTabs.id"
          placeholder="使用表名，查询与更新会引用"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="标题">
        <el-input
          v-model="them.conProPertiesTabs.title"
          placeholder="显示到面板的顶端"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="是否可编辑(可写表达式)(0不限制 1禁止编辑)">
        <el-input
          v-model="them.conProPertiesTabs.disable"
          placeholder="0不限制 1禁止编辑"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="是否只读(可写表达式)(0不限制 1只读)">
        <el-input
          v-model="them.conProPertiesTabs.readonly"
          placeholder="0不限制 1只读"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="发送MQ SQL">
        <el-input
          v-model="them.conProPertiesTabs.sqlmq"
          placeholder="生成mq消息体用的SQL"
        ></el-input>
      </el-form-item>
    ...
    <el-form
      ref="buttons"
      v-show="them.showConfigurationProperties === 'buttons'"
    >
      <el-form-item label="按钮id">
        <el-input
          v-model="them.conProPertiesButtons.id"
          :disabled="true"
          placeholder="按钮id"
        ></el-input>
      </el-form-item>
      <el-form-item label="按钮编码">
        <el-input
          v-model="them.conProPertiesButtons.code"
          placeholder="前端根据code"
        ></el-input>
      </el-form-item>
      <el-form-item label="按钮事件">
        <el-input
          v-model="them.conProPertiesButtons.event"
          placeholder="按钮事件，用于传递接口"
        ></el-input>
      </el-form-item>
      <el-form-item label="按钮名字">
        <el-input
          v-model="them.conProPertiesButtons.name"
          placeholder="做为按钮标签显示"
        ></el-input>
      </el-form-item>
      <el-form-item label="模式">
        <el-select
          v-model="them.conProPertiesButtons.rw_flag"
          placeholder="请选择"
        >
      ...
      <el-form-item label="图标">
        <el-input
          v-model="them.conProPertiesButtons.icon"
          placeholder="按钮图标"
        ></el-input>
      </el-form-item>
      <el-form-item label="迁移窗口id">
        <el-input
          v-model="them.conProPertiesButtons.tranfer_winid"
          placeholder="按钮图标"
        ></el-input>
      </el-form-item>
      <el-form-item label="参数">
        <el-input
          v-model="them.conProPertiesButtons.param"
          placeholder="参数"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="位置">
        <el-select
          v-model="them.conProPertiesButtons.position_left"
          placeholder="请选择"
        >
      ...
      <el-form-item label="新增前是否要做校验">
        <el-input
          v-model="them.conProPertiesButtons.has_required"
          placeholder=""
        ></el-input>
      </el-form-item>
    </el-form>
  ...
  data() {
    return {
      showInfo: {
        ...
        param: "lookupwindow",
        lookupcolumn: "lookupwindow",
        returnback: "lookupwindow",
        step: "editable",
      },
    };
  },
