export default {
    buttons: [
        ...
        },
        {
            ...
            icon: "edit",
            show_button:
                "{$.fs_hosp_deploy_order.pause_restart_flag} == 0  && ({$.fs_hosp_deploy_order.status} == 55) && {$.fs_hosp_deploy_order.has_rs_flag} == 1 ? '1':'0'",
            audit_flag: 0,
            tranfer_winid: null,
            returnback: null,
            permission_flag: null,
        ...
        },
        {
            ...
            icon: "reply",
            show_button:
                "{$.fs_hosp_deploy_order.pause_restart_flag} == 0 && {$.fs_hosp_deploy_order.status} > 2 ?'1':'0'",
            audit_flag: null,
            tranfer_winid: null,
            returnback: null,
            permission_flag: null,
    ...
    data_permission: {
        perm_id2:
            "1281,645,1255,1417,1228,1517,910,1423,1458,1460,1238,1528,1369,1306,1276,1404,1532,637,1373,1437,1278,1534,1439",
        perm_id1: "605"
    },
    window: {
        template: "bill",
                ...
                items: [
                    [
                        ...
                        },
                        {
                            ...
                            type: "string",
                            returnback:
                                "hosp_id,hosp_name,area_list,manager_id,manager_name,onhand_workload,first_flag,hardware_manager,hardware_manager_name,hardware_postman,hardware_postman_name,hardware_manager_phone",
                            required: "1",
                            lookupcolumn:
                                "id,name,region_list,manager_id,manager_name,onhand_workload,first_flag,hardware_manager,hardware_manager_name,hardware_postman,hardware_postman_name,hardware_manager_phone"
                        },
                        {
                            default: "1",
                            visible: "0",
                        ...
                        },
                        {
                            ...
                            uitype: "inner_table",
                            uicontent:
                                '[{"id":"aio_type","label":"基座类型","savelabel":"label", "uitype":"select","lookup":"/sys/lookup/codes/fs_aio_type"}, {"id":"aio_num", "type":"number","label":"基座数量"}]'
                        },
                        {
                            visible: "0",
                            updatable: "1",
                        ...
                        },
                        {
                            ...
                            uitype: "inner_table",
                            uicontent:
                                '[{"id":"aio_type","label":"一体机类型","savelabel":"label", "uitype":"select","lookup":"/sys/lookup/codes/aio_type"}, {"id":"aio_num", "type":"number","label":"一体机数量"}]'
                        },
                        {
                            visible: "0",
                            updatable: "1",
                        ...
                        },
                        {
                            ...
                            visible:
                                "{type} >0 && {type} < 7 && {status} >= 10 && {transfer_manager_id} == null || {type} >0 && {type} < 7 && {transfer_manager_id} == {$userid} ||  {type} >0 && {type} < 7 &&  {status} >15? '1':'0'",
                            size: "medium",
            ...
            tabs: {
                meta: [
                    ...
                    },
                    {
                        ...
                        computeColumns: {},
                        visible:
                            "{$.fs_hosp_deploy_order.status} >=10 && {$.fs_hosp_deploy_order.type} >0 && {$.fs_hosp_deploy_order.type} <= 6 ? '1':'0'",
                        updateColumns: [
                            "id",
                            "title1",
                            "order_id",
                        ...
                        remapColumns: {},
                        disable:
                            "({$.fs_hosp_deploy_order.final_interface_engineers} && {$.fs_hosp_deploy_order.final_interface_engineers}.indexOf({$userid}.toString())>-1) ||({$.fs_hosp_deploy_order.final_excute_engineers} && {$.fs_hosp_deploy_order.final_excute_engineers}.indexOf({$userid}.toString())>-1) ? '0':'1'",
                    ...
                    },
                    {
                        ...
                        remapColumns: {},
                        disable:
                            "{$.fs_hosp_deploy_order.status} >=55 &&{$.fs_hosp_deploy_order.final_interface_engineers} && {$.fs_hosp_deploy_order.final_interface_engineers}.indexOf({$userid}.toString())>-1 ? '0':'1'",
                    ...
                    },
                    {
                        ...
                        remapColumns: {},
                        disable:
                            "{$.fs_hosp_deploy_order.status} >=55 &&{$.fs_hosp_deploy_order.final_excute_engineers} && {$.fs_hosp_deploy_order.final_excute_engineers}.indexOf({$userid}.toString())>-1 ? '0':'1'",
                ...
                items: [
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            uitype: "textarea",
                            placeholder:
                                "数据库类型：orcal/mysql/sybase/sqlserver/db2/其他\n数据库连接IP及端口：\n用户名密码：",
                            type: "string",
                            rows: 3
                        },
                        {
